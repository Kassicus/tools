# Get the download URL of the latest winget installer
...
# If framework "Microsoft.UI.Xaml.2.7" is missing, following to install
#Invoke-WebRequest `
...
# If framework "Microsoft.VCLibs.140.00.UWPDesktop" missing, following to install
#Invoke-WebRequest `
...
# Then repeat initial install commands